...
# =============================================== #
  ...
  data.loc.1 <- "./Simulation/PALM_wald/"
  ...
  pdf("./Figure/FigureS13_FDR.pdf", width = 21, height = 5.6, bg = "white")

  pp1_1

  dev.off()

  pdf("./Figure/FigureS13_Power.pdf", width = 21, height = 5.6, bg = "white")

  pp1_2

  dev.off()

  pdf("./Figure/FigureS13_het.pdf", width = 21, height = 5.6, bg = "white")
